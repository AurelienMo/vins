 ...
 */
final class Version20200110143209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE amo_quizz (id VARCHAR(255) NOT NULL, amo_wine_id VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_DC8CD22D64D6BAC3 (amo_wine_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE amo_question (id VARCHAR(255) NOT NULL, amo_quizz_id VARCHAR(255) DEFAULT NULL, label LONGTEXT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_DB07A4A1D478C9 (amo_quizz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE box_wine_has_capacities DROP FOREIGN KEY FK_6889653966B6F0BA');
